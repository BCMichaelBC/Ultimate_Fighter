...
public class Combat : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if ((Input.GetKey(KeyCode.S) && states.isPlayerOne) || (Input.GetKey(KeyCode.DownArrow) && !states.isPlayerOne)) // To crouch
        {
            ...
            else if ((Input.GetKeyDown(KeyCode.G) && states.isPlayerOne) || (Input.GetKeyDown(KeyCode.K) && !states.isPlayerOne)) // crouch kick
            {
        ...
        if (states.onGround && !states.crouch) //idle position
        {
